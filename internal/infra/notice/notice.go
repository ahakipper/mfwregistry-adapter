// Package notice provides the deployment-owned AppCenter transport adapter,
// fail-closed fallback, and local-IP resolver used by the composition root.
package notice
...
// LocalIP returns the first non-loopback, globally unicast address
...
// getLocalIP performs the interface scan used by LocalIP.
