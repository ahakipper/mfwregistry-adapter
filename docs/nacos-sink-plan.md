...
> **Current-state addendum (2026-09-13, authoritative HEAD `e118882`):** This document contains the original F5
...
by the current-status addendum above and HEAD `e118882`. The lead implements it
