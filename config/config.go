...
// Package config contains the historical mutable configuration surface.
// Deprecated: new code must use internal/infra/config.Config values passed
// explicitly from the composition root.
